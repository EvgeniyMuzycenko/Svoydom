...
<head>
  <title>Строительство и проектирование домов под ключ в Удмуртской Республике | Свой Дом - строительная компания
  </title>
  <meta charset="utf-8">
...
?>
  <header>
    ...
    <div class="site_name">
      <h1>Строительство и проектирование домов под ключ<br> по Удмуртской Республике</h1>
    </div>
    <div class="auth">
      <?php
				if ($_SESSION['client']) {
