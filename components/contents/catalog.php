  ...
  <div class="articles">
    ...
    <?php
			...
			$run_out_cat=mysqli_query($connect,$str_out_cat);
					...
					echo "
					<a href=projects.php?id=$out_cat[id]><img src=assets/images/catalog/$out_cat[img_cat] width=370 alt=Изображение каталога><p>Проекты на $out_cat[name_cat]</p><br></a>";
					}
					?>
  </div>
</content>