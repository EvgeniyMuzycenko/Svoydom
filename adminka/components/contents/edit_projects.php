	...
	<article>
		...
		<div class="reg_form">
			<form method="POST" enctype="multipart/form-data" action="controllers/edit.php?edit_proj=<?=$out_proj['id']?>">
				<input type="text" name="name_proj" value="<?php echo $out_proj['name_proj'];?>" placeholder="Наименование проекта">
				...
				<input type="number" name="num_of_floors" value="<?php echo $out_proj['num_of_floors'];?>" placeholder="Кол-во этажей">
